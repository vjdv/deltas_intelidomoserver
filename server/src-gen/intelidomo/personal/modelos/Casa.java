...
import intelidomo.personal.modelos.commands.FuncionI;
import intelidomo.personal.modelos.obs.Observado;
import intelidomo.personal.modelos.obs.Observador;
import java.util.*;
import java.util.Map.Entry;
import java.util.logging.*;
import intelidomo.personal.modelos.voz.TextCommands;
import intelidomo.personal.modelos.voz.HumedadLink;
import intelidomo.personal.modelos.voz.TemperaturaLink;
import intelidomo.personal.modelos.voz.TemperaturasLink;
import intelidomo.personal.modelos.voz.CanalTvLink;
